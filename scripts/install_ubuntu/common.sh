...
print_manual_onlyoffice_hint() {
    ...
    log_manual "  3. Schriftarten (PDF/Druck): ttf-mscorefonts-installer, fonts-crosextra-carlito,"
    log_manual "     fonts-crosextra-caladea, fonts-liberation, fonts-liberation2, fonts-dejavu-core"
    ...
    log_manual "  5. Font-Index: docker exec onlyoffice-documentserver documentserver-generate-allfonts.sh"
