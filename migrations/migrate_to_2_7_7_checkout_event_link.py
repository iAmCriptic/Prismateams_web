#!/usr/bin/env python3
"""
Datenbank-Migration: Version 2.7.7

Inventar ↔ Veranstaltungen:
- checkouts.event_id
- checkouts.event_appointment_id

Aufruf:
  python migrations/migrate_to_2_7_7_checkout_event_link.py
"""
...
def migrate():
    ...
    with app.app_context():
        ...
        add_column_if_missing(
            ...
            "event_appointment_id INTEGER",
            "event_appointment_id INTEGER",
        )
        print("[DONE] Migration 2.7.7 abgeschlossen")
