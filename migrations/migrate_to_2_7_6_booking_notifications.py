#!/usr/bin/env python3
"""
Datenbank-Migration: Version 2.7.6

Benachrichtigungen:
- notification_settings.booking_notifications_enabled

Aufruf:
  python migrations/migrate_to_2_7_6_booking_notifications.py
"""
...
def migrate():
    ...
    with app.app_context():
        ...
        add_column_if_missing(
            ...
            "booking_notifications_enabled BOOLEAN NOT NULL DEFAULT 1",
            "booking_notifications_enabled BOOLEAN NOT NULL DEFAULT TRUE",
        )
        print("[DONE] Migration 2.7.6 abgeschlossen")
