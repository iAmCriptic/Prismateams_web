...
(function () {
    ...
    function initModViewToggle(options) {
        ...
        function applyInstant(mode) {
            ...
            gridPane.classList.remove('mod-view-pane--leave', 'files-view-pane--leave');
            listPane.classList.remove('mod-view-pane--leave', 'files-view-pane--leave');

            if (isList) {
                gridPane.style.display = 'none';
                gridPane.classList.remove('mod-view-pane--active', 'files-view-pane--active');
                listPane.style.display = 'block';
                listPane.classList.add('mod-view-pane--active');
                listPane.classList.remove('d-none');
                gridPane.classList.add('d-none');
            } else {
                listPane.style.display = 'none';
                listPane.classList.remove('mod-view-pane--active', 'files-view-pane--active');
                gridPane.style.display = 'block';
                gridPane.classList.add('mod-view-pane--active');
        ...
        function setView(mode, opts) {
            ...
            toPane.classList.remove('d-none', 'mod-view-pane--active', 'files-view-pane--active');
            fromPane.classList.add('mod-view-pane--leave');

            window.requestAnimationFrame(function () {
                window.requestAnimationFrame(function () {
                    fromPane.classList.remove('mod-view-pane--active', 'files-view-pane--active');
                    toPane.classList.add('mod-view-pane--active');
                });
            });

            window.setTimeout(function () {
                fromPane.style.display = 'none';
                fromPane.classList.remove('mod-view-pane--leave', 'mod-view-pane--active', 'files-view-pane--leave', 'files-view-pane--active');
